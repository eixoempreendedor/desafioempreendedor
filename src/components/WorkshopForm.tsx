...
const WA_URL = "https://wa.me/5561981726782";
    ...
    try {
      ...
      setTimeout(() => {
        const msg = encodeURIComponent(
          `Olá! Meu nome é ${form.nome}, sou da empresa ${form.empresa}. Quero confirmar minha vaga no workshop gratuito do dia 25/04.`
        );
    ...
    return (
      <div className="border border-gold bg-gold/10 p-8 text-center">
        ...
        <p className="mt-3 text-gray-text">
          {form.nome}, você será redirecionado para o WhatsApp para confirmar.
        </p>
        <p className="mt-2 text-sm text-gray-muted">
          Se não abrir automaticamente,{" "}
          <a
            href={`${WA_URL}?text=${encodeURIComponent(`Olá! Meu nome é ${form.nome}, sou da empresa ${form.empresa}. Quero confirmar minha vaga no workshop gratuito do dia 25/04.`)}`}
            target="_blank"
