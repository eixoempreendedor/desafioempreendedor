...
export const workshopFAQ = [
  ...
  {
    question: "Posso levar um sócio ou alguém da minha empresa?",
    answer:
      "Pode e deve. Se você tem sócio, o ideal é que os dois venham. As decisões mais importantes do negócio são tomadas em conjunto. Mas cada pessoa precisa se inscrever individualmente para garantir a vaga.",
  },
  {
  ...
  },
  {
    question: "Tem custo?",
    answer:
      "Zero. O workshop é 100% gratuito. Sem taxa, sem material pago, sem surpresa.",
  },
];
